...
def get_from_uop(args):
    ...
    try:
        ...
        attach_key(resource_name.decode(encoding="utf-8") if resource_name else "", query, "resource_name__contains", resource_name)
        attach_key(domain.decode(encoding="utf-8") if domain else "", query, "domain__contains", domain)
        attach_key(business_name.decode(encoding="utf-8") if business_name else "", query, "business_name__contains", business_name)
        attach_key(module_name.decode(encoding="utf-8") if module_name else "", query, "module_name__contains", module_name)
        attach_key(project_name.decode(encoding="utf-8") if project_name else "", query, "project_name__contains", project_name)
