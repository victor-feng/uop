...
def get_from_uop(args):
    ...
    try:
        ...
        attach_key(resource_name.decode("utf-8"), query, "resource_name__contains", resource_name)
        attach_key(business_name.decode("utf-8"), query, "business_name__contains", business_name)
        attach_key(module_name.decode("utf-8"), query, "module_name__contains", module_name)
        attach_key(project_name.decode("utf-8"), query, "project_name__contains", project_name)
