...
class PermissionList(db.Document):
    ...
    api_get = db.StringField(required=False)
    api_post = db.StringField(required=False)
    api_put = db.StringField(required=False)
    api_delete = db.StringField(required=False)
