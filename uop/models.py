...
class UserInfo(db.Document):
    ...
    is_root = db.BooleanField(required=False, default=False)
...
class Deployment(db.Document):
    ...
    resource_id = db.StringField(max_length=50)
    resource_name = db.StringField(max_length=50)
    created_time = db.DateTimeField(default=datetime.datetime.now())
    environment = db.StringField(max_length=50)
    release_notes = db.StringField(max_length=5000)
    mysql_tag = db.StringField(max_length=50)
    mysql_context = db.StringField(max_length=5000)
    redis_tag = db.StringField(max_length=50)
    redis_context = db.StringField(max_length=5000)
    mongodb_tag = db.StringField(max_length=50)
    mongodb_context = db.StringField(max_length=5000)
